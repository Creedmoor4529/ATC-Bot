...
# ---------------------------------------------------------------------------
# Runway database
# Each entry: (threshold1_lat, threshold1_lon, threshold2_lat, threshold2_lon,
#              width_m, designator)
# Thresholds are the two ends of the runway centerline.
# width_m is the half-width corridor on each side of the centerline.
# designator is the L/R/C-suffixed runway number (e.g. "25R", "14", "9C").
# For parallel runways the designator uses the lower-numbered base end and
# L/R is assigned from that end's pilot perspective.
# ---------------------------------------------------------------------------

# ICAO: list of (lat1, lon1, lat2, lon2, width_m, designator)
...
RUNWAYS: dict[str, dict[str, list[tuple[float, float, float, float, int, str]]]] = {
    "Afghanistan": {
        "OABM": [(34.8126, 67.8074, 34.8053, 67.8261, 28, "7")],
        "OABN": [(31.8646, 64.2209, 31.8357, 64.2264, 38, "1")],
        ...
        "OAIX": [
            (34.9317, 69.2730, 34.9598, 69.2588, 35, "3R"),
            (34.9321, 69.2721, 34.9602, 69.2578, 35, "3L"),
        ],
        "OAJL": [(34.3956, 70.4895, 34.4049, 70.5067, 20, "13")],
        "OAKB": [(34.5632, 69.1957, 34.5683, 69.2296, 38, "11")],
        "OAKN": [(31.4975, 65.8601, 31.5140, 65.8353, 35, "23")],
        ...
        "OASD": [(33.4023, 62.2605, 33.3830, 62.2616, 30, "36")],
    ...
    "GermanyCW": {
        ...
        "EDDB": [
            (52.3822, 13.5547, 52.3863, 13.5140, 38, "7L"),
            (52.3706, 13.5263, 52.3747, 13.4856, 38, "7R"),
        ],
        "EDDE": [(50.9829, 10.9751, 50.9761, 10.9496, 28, "28")],
        "EDDF": [
            (50.0400, 8.5959, 50.0408, 8.5388, 38, "7L"),
            (50.0335, 8.5896, 50.0343, 8.5326, 38, "7R"),
        ],
        "EDDH": [
        ...
        "EDDI": [
            (52.4695, 13.3899, 52.4726, 13.4187, 38, "9R"),
            (52.4738, 13.3892, 52.4762, 13.4181, 38, "9L"),
        ],
        "EDDK": [
            (50.8556, 7.1402, 50.8802, 7.1549, 38, "14L"),
            (50.8659, 7.1191, 50.8641, 7.1605, 38, "32"),
            (50.8555, 7.1242, 50.8742, 7.1354, 38, "7R"),
        ],
        "EDDL": [(51.2893, 6.7536, 51.2846, 6.7818, 38, "5")],
        "EDDP": [(51.4204, 12.2425, 51.4096, 12.2118, 38, "29")],
        "EDDT": [
            (52.5590, 13.3101, 52.5579, 13.2757, 35, "8R"),
            (52.5604, 13.3052, 52.5593, 13.2708, 35, "8L"),
        ],
        "EDDV": [
            (52.4581, 9.7094, 52.4509, 9.6781, 38, "9R"),
            (52.4710, 9.6953, 52.4639, 9.6640, 38, "9L"),
        ],
        ...
        "EKCH": [
            ...
            (55.6192, 12.6382, 55.6095, 12.6627, 38, "12R"),
            (55.6106, 12.5993, 55.5946, 12.6399, 38, "4L"),
        ],
    ...
    "Iraq": {
        "ORAA": [
            (33.7808, 42.4073, 33.7816, 42.4480, 35, "9R"),
            (33.7895, 42.4345, 33.7904, 42.4751, 35, "9L"),
        ],
        "ORAK": [
            (32.4804, 45.7429, 32.4873, 45.7683, 28, "11L"),
            (32.4775, 45.7435, 32.4844, 45.7689, 28, "11R"),
        ],
        "ORAS": [(33.2706, 44.4879, 33.2872, 44.5008, 35, "15")],
        "ORAT": [
            (33.3324, 43.5849, 33.3461, 43.6122, 35, "12L"),
            (33.3301, 43.5819, 33.3438, 43.6092, 35, "12R"),
        ],
        "ORBD": [
        ...
        "ORBI": [
            (33.2440, 44.2178, 33.2676, 44.2334, 35, "15R"),
            (33.2565, 44.2341, 33.2800, 44.2497, 35, "15L"),
        ],
        ...
        "ORTL": [
            (34.6595, 43.5290, 34.6763, 43.5438, 28, "14R"),
            (34.6718, 43.5451, 34.6887, 43.5599, 28, "14L"),
        ],
    },
    "Kola": {
    ...
    "MarianaIslands": {
        ...
        "PGUA": [
            (13.5874, 144.9175, 13.5760, 144.9446, 35, "6R"),
            (13.5921, 144.9159, 13.5807, 144.9430, 35, "6L"),
        ],
        "PGUM": [
            (13.4900, 144.7848, 13.4795, 144.8089, 35, "6L"),
            (13.4876, 144.7841, 13.4771, 144.8082, 35, "6R"),
        ],
    },
    "MarianaIslandsWWII": {
    ...
    "Nevada": {
        "K0L7": [
            (35.7644, -115.3262, 35.7740, -115.3329, 18, "2L"),
            (35.7632, -115.3259, 35.7728, -115.3327, 18, "2R"),
        ],
        ...
        "KHND": [
            (35.9805, -115.1328, 35.9675, -115.1333, 35, "17L"),
            (35.9783, -115.1352, 35.9652, -115.1357, 35, "17R"),
        ],
        ...
        "KLAS": [
            (36.0770, -115.1622, 36.0759, -115.1271, 35, "7L"),
            (36.0742, -115.1612, 36.0731, -115.1261, 35, "7R"),
        ],
        "KLSV": [
            (36.2453, -115.0431, 36.2251, -115.0229, 35, "3R"),
            (36.2471, -115.0456, 36.2269, -115.0255, 35, "3L"),
        ],
    ...
    "PersianGulf": {
        ...
        "OIBK": [
            (26.5262, 53.9650, 26.5301, 53.9971, 35, "10L"),
            (26.5235, 53.9647, 26.5274, 53.9969, 35, "10R"),
        ],
        ...
        "OISS": [
            (29.5497, 52.6093, 29.5321, 52.5728, 35, "11L"),
            (29.5459, 52.6074, 29.5284, 52.5709, 35, "11R"),
        ],
        "OIZJ": [(25.6592, 57.7923, 25.6501, 57.8105, 20, "6")],
        "OMAA": [
            (24.4424, 54.6395, 24.4650, 54.6691, 35, "13L"),
            (24.4424, 54.6688, 24.4198, 54.6391, 35, "31"),
            (24.4328, 54.6278, 24.4503, 54.6507, 35, "13R"),
        ],
        "OMAB": [(24.4220, 54.4508, 24.4341, 54.4664, 35, "13")],
        "OMAD": [
            (24.2384, 54.5344, 24.2581, 54.5610, 35, "13L"),
            (24.2212, 54.5377, 24.2409, 54.5643, 35, "13R"),
        ],
        "OMAL": [(24.2461, 55.6118, 24.2768, 55.6067, 35, "19")],
        "OMAW": [(23.6406, 53.8128, 23.6610, 53.8361, 20, "13")],
        "OMDB": [
            (25.2646, 55.3792, 25.2482, 55.3513, 35, "12L"),
            (25.2524, 55.3939, 25.2360, 55.3660, 35, "12R"),
        ],
        ...
        "OMSJ": [
            (25.3386, 55.5314, 25.3228, 55.5052, 35, "12L"),
            (25.3364, 55.5305, 25.3205, 55.5043, 35, "12R"),
        ],
    ...
    "SinaiMap": {
        "HEAR": [
            (31.0496, 33.8251, 31.0261, 33.8131, 35, "16R"),
            (31.0850, 33.8419, 31.0614, 33.8298, 35, "16L"),
        ],
        "HEAS": [
        ...
        "HEBA": [(30.9048, 29.6711, 30.9291, 29.6900, 35, "32")],
        "HEBH": [
            (26.5670, 33.1289, 26.5457, 33.1132, 35, "14R"),
            (26.5681, 33.1306, 26.5467, 33.1149, 35, "14L"),
        ],
        "HEBL": [
        ...
        "HEBN": [
            (29.2128, 31.0159, 29.1830, 31.0221, 35, "36R"),
            (29.2270, 30.9995, 29.2107, 31.0287, 35, "18"),
            (29.2105, 31.0138, 29.1860, 31.0190, 35, "36L"),
        ],
        "HEBR": [(30.8468, 30.9433, 30.8261, 30.9271, 30, "14")],
        "HEBZ": [(30.9978, 32.5612, 31.0017, 32.5432, 18, "25")],
        "HECA": [
            (30.1197, 31.4197, 30.0983, 31.4499, 35, "5R"),
            (30.1221, 31.3988, 30.1007, 31.4290, 35, "5L"),
        ],
        "HECW": [
            (30.1236, 30.8994, 30.0932, 30.8919, 35, "34L"),
            (30.1199, 30.9380, 30.1101, 30.9040, 35, "16"),
            (30.1320, 30.9178, 30.1064, 30.9115, 35, "28R"),
        ],
        "HEDS": [
        ...
        "HEGN": [
            (27.1597, 33.7865, 27.1932, 33.7969, 38, "16R"),
            (27.1606, 33.7961, 27.1941, 33.8066, 38, "16L"),
        ],
        ...
        "HEKB": [(30.2517, 32.5002, 30.2353, 32.4822, 28, "32")],
        "HEKH": [],
        "HEKW": [
        ...
        "HEMN": [
            (28.1128, 30.7348, 28.0893, 30.7245, 35, "16R"),
            (28.1133, 30.7361, 28.0897, 30.7258, 35, "16L"),
        ],
        "HEMS": [
        ...
        "HEMZ": [
            (30.4187, 33.1565, 30.4012, 33.1430, 35, "15R"),
            (30.4175, 33.1591, 30.3999, 33.1456, 35, "15L"),
        ],
        ...
        "HESH": [
            (27.9887, 34.3834, 27.9688, 34.4031, 35, "4L"),
            (27.9861, 34.3869, 27.9662, 34.4067, 35, "4R"),
        ],
        "HESL": [
            (30.8072, 32.0379, 30.7830, 32.0472, 35, "2L"),
            (30.8064, 32.0448, 30.7822, 32.0541, 35, "2R"),
        ],
        "HETB": [(30.2010, 33.4258, 30.1883, 33.3999, 30, "30")],
        "HETB2": [(29.5748, 34.7910, 29.6013, 34.7655, 38, "22")],
        "HEWJ": [
            (30.0875, 31.8283, 30.0576, 31.8383, 35, "1L"),
            (30.0647, 31.8330, 30.0348, 31.8431, 35, "1R"),
        ],
        "HEWR": [
            (28.9543, 31.7038, 28.9877, 31.6935, 35, "1R"),
            (28.9548, 31.7017, 28.9882, 31.6914, 35, "1L"),
        ],
        "HEZQ": [
            (30.6074, 31.6637, 30.5823, 31.6655, 35, "18R"),
            (30.6073, 31.6647, 30.5822, 31.6665, 35, "18L"),
        ],
        "LLBG": [
        ...
        "LLHB": [
            (31.2409, 34.6699, 31.2363, 34.6472, 35, "10L"),
            (31.2311, 34.6755, 31.2265, 34.6528, 35, "10R"),
        ],
        "LLHS": [
            (31.7665, 34.7161, 31.7544, 34.7346, 30, "5"),
            (31.7647, 34.7448, 31.7579, 34.7230, 30, "23R"),
            (31.7631, 34.7439, 31.7564, 34.7221, 30, "29L"),
        ],
        "LLKM": [(31.2622, 34.6486, 31.2590, 34.6313, 28, "28")],
        "LLMG": [(32.5973, 35.2200, 32.5970, 35.2405, 30, "9")],
        "LLNV": [
            (31.2121, 34.9961, 31.2046, 35.0281, 35, "8R"),
            (31.2144, 34.9914, 31.2069, 35.0234, 35, "8L"),
        ],
        "LLOV": [
            (29.9512, 34.9298, 29.9304, 34.9385, 35, "3L"),
            (29.9501, 34.9332, 29.9293, 34.9419, 35, "3R"),
        ],
        ...
        "LLRM": [
            (30.7824, 34.6541, 30.7728, 34.6782, 28, "7L"),
            (30.7797, 34.6563, 30.7701, 34.6803, 28, "7R"),
        ],
        "LLSD": [(32.1094, 34.7853, 32.1200, 34.7793, 28, "21")],
        "LLTN": [
            (31.8460, 34.8177, 31.8261, 34.8180, 30, "36"),
            (31.8463, 34.8328, 31.8293, 34.8208, 30, "18L"),
            (31.8468, 34.8388, 31.8297, 34.8266, 35, "33R"),
        ],
        ...
        "OSDI": [
            (33.4063, 36.4975, 33.3846, 36.5230, 38, "5R"),
            (33.4364, 36.5056, 33.4147, 36.5311, 38, "5L"),
        ],
        "OSKH": [
    ...
    "Syria": {
        ...
        "LLPM": [
            (31.9058, 34.6886, 31.8950, 34.6957, 38, "3R"),
            (31.9058, 34.6868, 31.8950, 34.6940, 38, "3L"),
        ],
        "LLRD": [
        ...
        "LLTN": [
            (31.8472, 34.8374, 31.8295, 34.8278, 38, "33L"),
            (31.8265, 34.8193, 31.8459, 34.8165, 38, "15"),
            (31.8468, 34.8319, 31.8286, 34.8220, 38, "18R"),
        ],
        ...
        "OSDI": [
            (33.4353, 36.5039, 33.4157, 36.5331, 35, "5L"),
            (33.4052, 36.4957, 33.3856, 36.5250, 35, "5R"),
        ],
...
def runway_designators(icao: str, map_name: str) -> list[str]:
    """Return the designators of each physical runway at an airfield.

    Each physical runway contributes one designator — the one matching
    threshold1's approach end. The reciprocal end is implied.
    """
    return [r[5] for r in RUNWAYS.get(map_name, {}).get(icao.upper(), [])]

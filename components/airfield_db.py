...
RUNWAYS: dict[str, list[tuple[float, float, float, float, int]]] = {
    ...
    # CAUCASUS
    "UGSB": [(41.6025, 41.5887, 41.6175, 41.6107, 18)],   # Batumi 13/31
    "UGKS": [(41.9121, 41.7107, 41.9305, 41.7388, 18)],   # Kobuleti 07/25
    "UGSN": [(42.2301, 42.0357, 42.2488, 42.0798, 18)],   # Senaki 09/27
    "UGKO": [(42.1614, 42.4551, 42.1908, 42.4945, 18)],   # Kutaisi 08/26
    "UGSS": [(42.8479, 41.1079, 42.8660, 41.1501, 18)],   # Sukhumi 12/30
    "UGKG": [(43.0939, 40.5618, 43.1115, 40.6008, 18)],   # Gudauta 12/30
    "UGTB": [(41.6591, 44.9204, 41.6776, 44.9892, 18)],   # Tbilisi 13R/31L
    "URKA": [(45.0115, 37.3328, 44.9945, 37.3620, 18)],   # Anapa 22/04
    "URSS": [(43.4401, 39.9329, 43.4588, 39.9799, 18)],   # Sochi 06/24
    "URKH": [(44.6726, 39.9982, 44.6908, 40.0714, 18)],   # Maykop 09/27
    "URKG": [(44.9510, 37.9751, 44.9693, 38.0283, 18)],   # Krymsk 09/27
    "URRR": [(45.0087, 38.9368, 45.0348, 38.9997, 18)],   # Krasnodar-Center 09/27
    "URKK": [(45.0192, 39.1337, 45.0500, 39.2064, 18)],   # Krasnodar-Pashkovsky 09/27
    "URMM": [(44.2107, 43.0517, 44.2370, 43.1108, 18)],   # Mineralnye Vody 12/30
    "URMO": [(43.1952, 44.5762, 43.2183, 44.6376, 18)],   # Beslan 11/29
    "URKN": [(43.5014, 43.6082, 43.5233, 43.6627, 18)],   # Nalchik 12/30
    "URMZ": [(43.7812, 44.5949, 43.7960, 44.6218, 18)],   # Mozdok 10/28

    # PERSIAN GULF
    "OMAD": [(24.2296, 54.5164, 24.2659, 54.5777, 18)],   # Al Dhafra 13L/31R
    "OMDM": [(25.0106, 55.3418, 25.0434, 55.3949, 18)],   # Al Minhad 09/27
    "OMDB": [(25.2396, 55.3522, 25.2636, 55.3956, 18)],   # Dubai 12L/30R
    "OIKB": [(27.2015, 56.3558, 27.2339, 56.4009, 18)],   # Bandar Abbas 21/03
    "OOKB": [(26.1618, 56.2263, 26.1806, 56.2612, 18)],   # Khasab 17/35

    # CYPRUS
    "LCLK": [(34.8694, 33.6063, 34.8810, 33.6437, 18)],   # Larnaca 04/22
    "LCPH": [(34.7129, 32.4751, 34.7232, 32.5063, 18)],   # Paphos 11/29
    "LCRA": [(34.5910, 32.9620, 34.5920, 33.0101, 18)],   # Akrotiri 10/28

    # SYRIA
    "OSLK": [(35.3892, 35.9290, 35.4123, 35.9687, 18)],   # Latakia 17/35
    "OSAP": [(36.1693, 37.2173, 36.1864, 37.2311, 18)],   # Aleppo 09/27
    "OSDI": [(33.4028, 36.5020, 33.4208, 36.5291, 18)],   # Damascus 23/05
    "LTAG": [(36.9901, 35.4097, 37.0098, 35.4435, 18)],   # Incirlik 05/23

    # NEVADA
    "KLSV": [(36.2196, -115.0512, 36.2563, -115.0332, 18)],  # Nellis 03R/21L
    "KLAS": [(36.0712, -115.1735, 36.0951, -115.1411, 18)],  # Las Vegas 01L/19R
    "KINS": [(36.5731, -115.6902, 36.5961, -115.6612, 18)],  # Creech 03/21
}

...
- When a pilot reports inbound for a runway (on Approach frequency): respond with radar contact, their distance from the field, and vector them to a 5-mile straight-in final for the active runway. Use MAG-BRG-TO-5MI-FINAL from the requesting aircraft's TRAFFIC entry — that value is the magnetic heading from their current position directly to the 5-mile final waypoint on the extended centerline. Do NOT use MAG-BRG-TO-FIELD (that points at the runway, not the final approach fix) and do NOT substitute the runway heading. Instruct them to contact Tower at 10 miles. Do NOT request fuel state. Example: "VIPER 11, {base_callsign} APPROACH, radar contact, 41 miles, fly heading 095, vectors for a 5-mile straight-in runway {active_runway}, contact Tower at 10 miles."
